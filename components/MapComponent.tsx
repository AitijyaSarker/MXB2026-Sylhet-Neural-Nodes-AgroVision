                  ...
                  <div className="min-w-[200px]">
                    ...
                    {userLocation && (
                      <a
                        ...
                        className="inline-flex items-center gap-1 text-sm bg-green-600 text-white px-3 py-1 rounded-lg hover:bg-green-700 transition-colors"
                      >
                        <ExternalLink className="w-3 h-3" />
                        {lang === 'bn' ? 'দিকনির্দেশনা' : 'Directions'}
                      </a>
                    )}
                  </div>
                </Popup>
